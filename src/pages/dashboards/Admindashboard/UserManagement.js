...
export default function UserManagement() {
  ...
  const users = [
    ...
    },
    {
      initials: "SN",
      name: "Suresh Nair",
      email: "suresh.nair@precisioncast.com",
      role: "Production Manager",
    ...
    },
    {
      initials: "KJ",
      name: "Kavita Joshi",
      email: "kavita.joshi@precisioncast.com",
      role: "Quality Manager",
                    ...
                    >
                      ...
                      {openMenuIndex === i && (
                        <div
                          ...
                          style={{ right: 0, top: "28px", minWidth: "200px" }}
                        >
                          <button
                            className="dropdown-item d-flex align-items-center"
                            onClick={() => console.log("Edit Permissions", u)}
                          >
                            <i className="bi bi-shield-lock me-2"></i>Edit
                            Permissions
                          </button>
                          <button
                            className="dropdown-item d-flex align-items-center"
                            onClick={() => console.log("Reset Password", u)}
                          >
                            <i className="bi bi-key me-2"></i>Reset Password
                          </button>
                          <button
                            className="dropdown-item d-flex align-items-center"
                            onClick={() => console.log("Send Reset Email", u)}
                          >
                            <i className="bi bi-envelope me-2"></i>Send Password
                            Reset Email
                          </button>
                          <div className="dropdown-divider"></div>
                          <button
                            className="dropdown-item d-flex align-items-center"
                            onClick={() => console.log("Activity Log", u)}
                          >
                            <i className="bi bi-activity me-2"></i>View Activity
                            Log
                          </button>
                          <button
                            className="dropdown-item d-flex align-items-center"
                            onClick={() => console.log("Login History", u)}
                          >
                            <i className="bi bi-clock-history me-2"></i>Login
                            History
                          </button>
                          <div className="dropdown-divider"></div>
                          <button
