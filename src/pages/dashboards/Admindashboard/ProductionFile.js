  ...
  const renderActions = (row) => {
    return (
      <div className="d-flex align-items-center gap-3">
        ...
        {/* COMMON */}
        <FaEye
          style={{ color: "#3e78f6", cursor: "pointer" }}
    ...
    <div className="container-fluid py-3">
      <div className="container-fluid">
        ...
        <div className="d-flex justify-content-between align-items-center mb-3 mt-3">
          ...
          >
            <FaPlus style={{marginRight:"5px"}}/> Create Work Orders
          </button>
        </div>
              ...
              <tr key={index}>
                ...
                <td style={{ width: "140px", padding: "14px 10px" }}>
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <small style={{ fontSize: "13px" }}>{row.progress}%</small>
                  </div>
                </td>
                ...
                {/* ACTIONS */}
                <td style={{ padding: "14px 10px" }}>{renderActions(row)}</td>
              </tr>
            ))}
          </tbody>
        </table>
