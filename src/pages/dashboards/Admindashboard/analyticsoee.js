        ...
        >
          ...
          >
            ...
            <div className="mt-auto d-flex justify-content-between align-items-end pt-3">
              {/* LEFT SIDE */}
              <div>
                <p className="small text-muted mb-1">Supported formats:</p>
            ...
            >
              <div className="d-flex align-items-center gap-3">
                ...
                <div>
                  ...
                  <small className="text-muted">Structured data format</small>
                </div>
              </div>
          ...
          >
            ...
            >
              <p className="small mb-0">
                <strong>Print Preview:</strong> The report will include all OEE
                metrics, Six Big Losses analysis, and production statistics.
              </p>
            </div>
            ...
            <div className="mb-4">
              ...
              <ul className="small text-muted ps-3 mb-0">
                ...
                <li className="mb-1">
                  Production, Procurement, and Sales Metrics
                </li>
          ...
          >
            ...
            >
              ...
              <div className="mb-4 text-center">
                {/* MAIN TITLE */}
                <h4 className="fw-bold mb-1" style={{ color: "#17026c" }}>
                  ...
                  >
                    ...
                    <thead>
                      <tr style={{ backgroundColor: "#e9ecef" }}>
                        <th className="fw-semibold text-start p-2">
                          Loss Category
                        </th>
                        <th className="fw-semibold text-start p-2">
                          Hours/Day
      ...
      <div className="row g-4">
        {[
          ...
          },
          {
            ...
            value: "87.2%",
            color: "#10b981",
            sub: "Uptime vs Planned Time",
          },
          {
            title: "Performance",
            value: "91.5%",
            color: "#10b981",
            sub: "Speed vs Ideal Cycle Time",
          },
          {
            title: "Quality (FPY)",
            value: "99.6%",
      ...
      <div className="card mt-4 p-4 shadow-sm" style={{ borderRadius: "12px" }}>
        ...
        <div className="table-responsive">
          <table
            ...
            style={{ borderCollapse: "collapse", borderSpacing: "0 10px" }}
          >
            <thead
