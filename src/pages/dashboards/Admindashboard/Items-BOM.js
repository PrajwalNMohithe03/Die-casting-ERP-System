...
export default function ItemsBOM() {
  ...
  const items = [
    {
      code: "RM-001",
      name: "Aluminum Alloy A380 Ingot",
    ...
    {
      code: "RM-004",
      name: "Aluminum Alloy ADC12 Ingot",
      category: "Raw Material",
      type: "Metal",
      stock: "3,100",
      unit: "kg",
    ...
    {
      code: "RM-005",
      name: "Die Release Agent (Lubricant)",
      category: "Raw Material",
      type: "Chemical",
      stock: "85",
      unit: "liters",
    ...
    {
      code: "FG-001",
      name: "Automotive Gearbox Housing",
    ...
    {
      code: "FG-005",
      name: "Motorcycle Crankcase Cover",
      category: "Finished Good",
      type: "Automotive",
      stock: "1200",
      unit: "pcs",
    ...
    {
      code: "FG-007",
      name: "Water Pump Impeller Housing",
      category: "Finished Good",
      type: "Industrial",
      stock: "190",
      unit: "pcs",
    ...
    {
      code: "DM-001",
      name: "Die - Gearbox Housing (2-Cav)",
      category: "Die/Mold",
      type: "Tooling",
      stock: "— (42,800 / 80,000)",
      unit: "—",
        ...
        <div className="d-flex justify-content-between align-items-center mb-3 mt-3">
          <div>
            ...
            <p style={{ color: "#64748b", marginBottom: "25px" }}>
              Manage items, raw materials, finished goods, and components
            </p>
          </div>
          <button
            onClick={() => {
          ...
          >
            <FaPlus style={{marginRight:"5px"}}/> Add New Item
          </button>
        </div>

        {showForm && mode === "add" && (
          <AddNewItemForm onClose={() => setShowForm(false)} />
        )}
            ...
            <tbody>
              {filteredItems.map((item, i) => (
                <tr
                  ...
                  style={{
                    backgroundColor:
                      item.status === "Low Stock" ? "#f8f3e7" : "transparent",
                  }}
                >
                  <td
                    style={{
                  ...
                  <td>
                    {(() => {
                      ...
                      if (
                        ["DM-001", "DM-002", "DM-003", "DM-004"].includes(
                          item.code,
                        )
                      ) {
                        return (
                    ...
                    >
                      ...
                      {openMenuIndex === i && (
                        ...
                        >
                          ...
                          >
                            <i className="bi bi-clock-history me-2"></i>Stock
                            History
                          </button>
