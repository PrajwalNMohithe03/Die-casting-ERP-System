...
import { FaSearch, FaFilter, FaPrint, FaPlus } from "react-icons/fa";
import {
  FaCheckCircle,
  FaClock,
  FaExclamationCircle,
...
export default function Procurement() {
  ...
  const filteredData =
    statusFilter === "All Status"
      ? data
      : data.filter(
          (row) => row.statusText.toLowerCase() === statusFilter.toLowerCase(),
        );
    ...
    <div className="container-fluid py-3">
      <div className="container-fluid">
        ...
        <div className="d-flex justify-content-between align-items-center mb-3 mt-3">
          ...
          >
            <FaPlus style={{marginRight:"5px"}}/> Create Purchase Order
          </button>
        </div>
        ...
        <div className="row g-3 mb-4 mt-4">
          ...
          <div className="col-md-3">
            <div
              className="card p-3 border-1 d-flex flex-row align-items-center gap-3"
              style={cardStyle}
            >
                ...
                >
                  ...
                  <div className="d-flex justify-content-between align-items-start">
                    ...
                    <div className="text-end">
                      ...
                      <div className="small text-muted">{sup.contact}</div>
                    </div>
                  </div>
